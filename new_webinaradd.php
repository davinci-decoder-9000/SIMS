...
<?php
	...
	if(isset($_POST["title"])){
		...
		$sql = "INSERT INTO seminar_tb(title, host, description, initial_date, end_date, active) VALUES(:title, :host, :description, :initial_date, :end_date, :active)";
		
		try {
			$result = $conn->prepare($sql);
			$values = array(":title" => $title, ":host" => $host, ":description" => $description, ":initial_date" => $initial_date,":end_date" => $end_date, ":active" => $active);
 ...
 <form action="" method="post">
	  <div class="mb-2">
                  ...
                  <div class="p-5 mx-auto container shadow">
                        ...
                        <div class="row text-center">
                              <input type="text" name="host" id="" class="h2 text-center">
                        </div>
						<br>
                        <div class="row text-center">
                              <h2>Active</h2>
