            ...
            <div class="d-grid b-5 w-100">
                  <div id="app" class="container-fluid text-center">
                        <?php 
                              ...
                              $cardIcon = array("../Assets/icons/main_menu/CSOrg.png",
                                                '../Assets/icons/main_menu/SUBJECT.png',
                                                '../Assets/icons/main_menu/REASERCH.png',
                                                '../Assets/icons/main_menu/ACTIVITIES.png');
