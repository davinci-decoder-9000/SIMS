...
?>
                              ...
                              <div class="row mb-3">
                                    <?php echo ($_GET['page'] > 0)? '<a href="./subject_page.php?page='. --$page .'" class="col-1 btn btn-secondary">Prev</a>' : '<div class="col-1"></div>' ?>
                                    <h3 class="col" ><?php if ($year != 1 && $year != 2) echo $year['sch_year']?></h3>
                                    <?php echo ($year != 1 && $year != 2)? '<a href="./subject_page.php?page='.++$_GET['page'].'" class="col-1 btn btn-secondary">Next</a>' : '<div class="col-1"></div>'?>
                              </div>
<?php
                              if ($year != 1 && $year != 2) {
